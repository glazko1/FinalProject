...
public interface AlienSpecialistService {
    ...
    void addAlien(long id, String alienName, String planet, String description, String movieTitle, String imagePath) throws ServiceException;
    ...
    void deleteAlien(long alienId) throws ServiceException;
}
