    ...
    <form method="post" action="mainWindow">
        ...
        <table align="center">
            ...
            <tr>
                ...
                <td align="center">
                    <label>
                        <input type="password" required pattern="[A-Za-z0-9][A-Za-z0-9_-]{6,28}[A-Za-z0-9]" name="password" title="<fmt:message key="message.password_format" />">
                    </label>
                </td>
            </tr>
        </table>
    ...
    <form method="post" action="mainWindow">
        ...
        <table align="center">
            <tr>
                ...
                <td align="center">
                    <label>
                        <input type="text" required pattern="[A-Za-z0-9][A-Za-z0-9_-]{4,13}[A-Za-z0-9]" name="newUsername" title="<fmt:message key="message.username_format" />" />
                    </label>
                </td>
            </tr>
            <tr>
