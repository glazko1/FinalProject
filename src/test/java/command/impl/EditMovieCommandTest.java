...
public class EditMovieCommandTest {
    ...
    public void execute_serviceExceptionFromEditMovie_CommandException() throws ServiceException, CommandException {
        //given
    ...
    @Test
    public void execute_invalidMovieInformationExceptionFromEditMovie_main() throws ServiceException, CommandException {
        //given
        HttpServletRequest mockRequest = mock(HttpServletRequest.class);
        HttpServletResponse mockResponse = mock(HttpServletResponse.class);
        MovieFanService service = mock(MovieFan.class);
        ...
        doThrow(InvalidMovieInformationException.class).when(service).editMovie(anyString(), anyString(), anyString(), any());
